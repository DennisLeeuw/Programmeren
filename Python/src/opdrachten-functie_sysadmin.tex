...
\item Automatisch gebruikers aanmaken
	...
	\item[Opdracht] Maak een functie \textquote{maak\_gebruiker\_aan(gebruikersnaam)} die een nieuwe gebruiker zou kunnen aanmaken (simulatie, geen echte systeemverandering).
