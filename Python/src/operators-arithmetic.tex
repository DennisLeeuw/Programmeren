...
De Arithmetic operators\index{Arithmetic operators} zijn de operators voor rekenkundige bewerkingen. Zie \ref{table:compop} de arithmetic operators in Python.
\begin{flushleft}
\begin{table}[h!]
\centering
