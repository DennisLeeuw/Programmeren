...
De Arithmetic operators\index{Arithmetic operators} zijn de operators voor rekenkundige bewerkingen. Zie tabel \ref{table:compop} voor een overzicht van de arithmetic operators in Python.
\begin{flushleft}
\begin{table}[h!]
\centering
